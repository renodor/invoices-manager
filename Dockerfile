...
# docker build -t invoices-manager .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name invoices-manager invoices-manager
